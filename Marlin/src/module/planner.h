...
enum BlockFlagBit : char {
  ...
  // Reset shaper E axis position
  BLOCK_BIT_RESET_E_POSITION,

  // Reset shaper B axis position
  BLOCK_BIT_RESET_B_POSITION,

  // Change extruder
  BLOCK_BIT_CHG_EXTRUDER
};
...
enum BlockFlag : char {
  ...
  BLOCK_FLAG_RESET_E_SHAPER_POSITION      = _BV(BLOCK_BIT_RESET_E_POSITION),
  BLOCK_FLAG_RESET_B_SHAPER_POSITION      = _BV(BLOCK_BIT_RESET_B_POSITION),
  BLOCK_FLAG_CHG_EXTRUDER                 = _BV(BLOCK_BIT_CHG_EXTRUDER)
};
